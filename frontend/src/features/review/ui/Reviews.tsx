...
export const Reviews = ({ type }: ReviewsProps) => {
    ...
    return (
        ...
        `}
                                            ...
                                            <div
                                                className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 pt-4 border-t border-base-300">
                                                <div className="hidden sm:block tooltip tooltip-right"
                                                     data-tip="Был ли отзыв полезен?">
                                                    <button
